...
curl -sf https://github.com/polybar/polybar-scripts/blob/master/polybar-scripts/openweathermap-fullfeatured/openweathermap-fullfeatured.sh --output ~/dotfiles/configs/scripts/polybar-weathermap.sh
